...
public static class LucideHelpers
{
    ...
    public static StringBuilder CreateClassBuilder(string className)
    {
        ...
        builder.AppendLine("/// A collection of Lucide icons.");
        builder.AppendLine("/// </summary>");
        builder.AppendLine("/// <remarks>");
        builder.AppendLine("/// This file is automatically generated by <c>lucide-osu-framework</c>.");
        builder.AppendLine("/// </remarks>");
    ...
    public static async Task<JsonDocument> GetLucideInfoAsync()
    {
